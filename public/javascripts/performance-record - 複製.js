...
document.addEventListener('DOMContentLoaded', function() {
	...
	window.addEventListener('resize', _.debounce(handleResize, 200)); // 建議加入 debounce 防抖
});
...
function handleResize() {
    ...
    // 重新執行所有繪圖函式
    createScoreSource(currentKpiData);
    createSupervisorDonut(currentKpiData);
    createSelfTypeDonut(currentKpiData);
    createSelfScoreSingleDonut2(currentKpiData);
}
